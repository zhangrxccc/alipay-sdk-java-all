...
import com.alipay.api.domain.AlipayOpenAppLocalitemSpuSaveModel;
...
public class AlipayOpenAppLocalitemSpuSaveRequest implements AlipayRequest<AlipayOpenAppLocalitemSpuSaveResponse> {
	...
	* 小程序本地商品SPU保存
	...
	public Class<AlipayOpenAppLocalitemSpuSaveResponse> getResponseClass() {
		return AlipayOpenAppLocalitemSpuSaveResponse.class;
	}

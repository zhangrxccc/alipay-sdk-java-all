...
import com.alipay.api.domain.AlipayOpenAppLocalitemCalendarpriceSaveModel;
...
public class AlipayOpenAppLocalitemCalendarpriceSaveRequest implements AlipayRequest<AlipayOpenAppLocalitemCalendarpriceSaveResponse> {
	...
	* 保存本地商品日历价格
	...
	public Class<AlipayOpenAppLocalitemCalendarpriceSaveResponse> getResponseClass() {
		return AlipayOpenAppLocalitemCalendarpriceSaveResponse.class;
	}

...
import com.alipay.api.domain.AlipayMerchantIndirectAuthorderCloseModel;
...
public class AlipayMerchantIndirectAuthorderCloseRequest implements AlipayRequest<AlipayMerchantIndirectAuthorderCloseResponse> {
	...
	* 间连商户意愿确认申请单撤销
	...
	public Class<AlipayMerchantIndirectAuthorderCloseResponse> getResponseClass() {
		return AlipayMerchantIndirectAuthorderCloseResponse.class;
	}
